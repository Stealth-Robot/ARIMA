...
class Theme(db.Model):
    ...
    update_type_style = db.Column(db.Text)
    update_type_perf = db.Column(db.Text)
    update_type_code = db.Column(db.Text)

    # Proxy change type badge colours (For Me page)
    proxy_type_rating = db.Column(db.Text)
    proxy_type_note = db.Column(db.Text)
