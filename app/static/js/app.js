...
function showNoteInput(cell, songId) {
    ...
    // Get song name from first cell in the same row (use link text or data attribute to avoid edit-mode button text)
...
// Highlight a table row with pulse glow animation
